...
```
CommandLine.keyword:(*\\:\\\\RECYCLER\\\\* *\\:\\\\SystemVolumeInformation\\\\* %windir%\\\\Tasks\\\\* %systemroot%\\\\debug\\\\*)
```
...
```
(CommandLine="*:\\\\RECYCLER\\\\*" OR CommandLine="*:\\\\SystemVolumeInformation\\\\*" OR CommandLine="%windir%\\\\Tasks\\\\*" OR CommandLine="%systemroot%\\\\debug\\\\*")
```
...
```
CommandLine IN ["*:\\\\RECYCLER\\\\*", "*:\\\\SystemVolumeInformation\\\\*", "%windir%\\\\Tasks\\\\*", "%systemroot%\\\\debug\\\\*"]
```
